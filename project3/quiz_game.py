import quiz_game as qg  # imports local module
...
# Prints start game sequence to the screen
print "*" * 100
...
# Checks for correct difficulty choice and returns correct value
qg.game_dificulty(user_difficulty, levels)
# Sets up the game board and loads the answers
gb, answers = qg.game_board(user_difficulty, question_bank, answers)
# Game engine prints game board to screen and begins game
